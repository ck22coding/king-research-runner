...
// growth_signals is 6, not the old 3: it absorbed the retired `news` section's
// launches / expansions / regulatory wins (2026-08-12), and a product launch or
// FDA clearance stays relevant well past 3 months even though a hiring snapshot
// doesn't. The tighter semantic for perishable hiring data is enforced at
// research time by the skill, not by this gate.
